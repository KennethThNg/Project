...
\subsubsection{Distribution of the date}

\subsection{Recovery process}

\subsection{Enrichment}

\subsection{Cleaning content}

\section{Emails classification}

Classification requires an unsupervised algorithm because the data is unstructured.

\subsection{Map position}

\subsection{What words reveal}
